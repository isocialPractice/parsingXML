...
[PHP Installations Doumentation](https://www.php.net/manual/en/install.general.php)
[PHP Downloads](https://www.php.net/downloads.php)
[PHP Mac Download](https://www.php.net/manual/en/install.macosx.packages.php)
[PHP Windows Download](https://windows.php.net/download/)
<br>
